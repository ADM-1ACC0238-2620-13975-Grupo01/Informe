...
|---|---|
| **Específico** | Obtener y conservar una posición junior enfocada en desarrollo backend con C# y ASP.NET Core. |
| **Medible** | Postular a 6 vacantes pertinentes por mes, realizar 2 simulaciones de entrevista mensuales y publicar 2 proyectos backend. |
| **Alcanzable** | Utilizará su formación universitaria y proyectos de portafolio para postular a empresas peruanas, consultoras y equipos remotos de la región. |
...
| Criterio SMART | Aplicación concreta |
|---|---|
| **Específico** | Profundizar en arquitectura, Domain-Driven Design y fundamentos de nube aplicados al backend. |
| **Medible** | Completar 120 horas de formación, desarrollar 1 proyecto documentado y presentarlo ante un docente, equipo o comunidad profesional. |
| **Alcanzable** | Estudiará 4 horas semanales y priorizará recursos gratuitos, de bajo costo o financiados por su empleador. |
| **Relevante** | La especialización complementará su experiencia backend y lo preparará para diseñar soluciones de mayor complejidad. |
| **Temporal** | Cumplirá la formación y el proyecto dentro de los 24 meses posteriores a su graduación. |
...
| Criterio SMART | Aplicación concreta |
|---|---|
| **Específico** | Crear una aplicación móvil con Flutter y otra solución conectada a una API propia. |
| **Medible** | Publicar 2 aplicaciones, recibir retroalimentación de 3 profesionales e incorporar al menos 5 mejoras. |
| **Alcanzable** | Definirá alcances pequeños, trabajará en entregas quincenales y reutilizará conocimientos adquiridos durante la carrera. |
...
| Criterio SMART | Aplicación concreta |
|---|---|
| **Específico** | Aprender metodologías ágiles y coordinar una iniciativa académica, comunitaria o laboral de 3 a 5 participantes. |
| **Medible** | Completar 60 horas de formación, entregar al menos el 80 % del alcance acordado y registrar 3 aprendizajes en una retrospectiva. |
| **Alcanzable** | Empezará con un equipo y un alcance reducidos, utilizando un backlog y reuniones breves de seguimiento. |
| **Relevante** | La experiencia mejorará su capacidad de colaborar y asumir gradualmente responsabilidades de coordinación. |
| **Temporal** | Completará la formación y la iniciativa dentro de los 18 meses posteriores a su graduación. |
...
| Criterio SMART | Aplicación concreta |
|---|---|
| **Específico** | Ingresar a un equipo o proyecto de desarrollo móvil para Android o Flutter. |
| **Medible** | Postular a 6 oportunidades por mes, realizar 2 simulaciones de entrevista mensuales y presentar 2 aplicaciones móviles terminadas. |
| **Alcanzable** | Preparará una aplicación con Kotlin y otra con Flutter, y postulará a empresas peruanas y equipos remotos de nivel junior. |
...
| Criterio SMART | Aplicación concreta |
|---|---|
| **Específico** | Fortalecer pruebas unitarias, pruebas de interfaz, seguridad básica y generación de versiones móviles. |
| **Medible** | Completar 80 horas de formación, cubrir al menos el 70 % de la lógica crítica y corregir todos los defectos de severidad alta detectados. |
| **Alcanzable** | Dedicará 3 horas semanales, conservará reportes de prueba y solicitará revisión de código antes de cada versión importante. |
| **Relevante** | Estas prácticas mejorarán la estabilidad de sus aplicaciones y su perfil como desarrollador móvil. |
| **Temporal** | Completará la formación y las mejoras dentro de los 18 meses posteriores a su graduación. |
...
| Criterio SMART | Aplicación concreta |
|---|---|
| **Específico** | Diseñar o desarrollar 2 productos pequeños vinculados con necesidades reales de educación, servicios, comercio o productividad. |
| **Medible** | Validar cada producto con al menos 5 usuarios, aplicar 3 mejoras por producto y publicar 2 casos de estudio. |
| **Alcanzable** | Elegirá alcances reducidos y podrá trabajar en proyectos laborales, independientes o de voluntariado. |
...
| Criterio SMART | Aplicación concreta |
|---|---|
| **Específico** | Incorporarse a una organización peruana o equipo remoto regional en una función vinculada con productos digitales. |
| **Medible** | Postular a 5 vacantes adecuadas por mes y participar en 1 actividad de empleabilidad o comunidad profesional cada 2 meses. |
| **Alcanzable** | Adaptará su CV y portafolio al perfil solicitado y reforzará semanalmente la competencia más recurrente en las vacantes. |
| **Relevante** | La posición le permitirá aplicar su formación y definir con experiencia real la especialidad que desea desarrollar. |
| **Temporal** | Conseguirá la posición dentro de los 15 meses posteriores a su graduación y completará 6 meses continuos de experiencia. |
...
| Criterio SMART | Aplicación concreta |
|---|---|
| **Específico** | Ingresar a una función junior en la que pueda diseñar, ejecutar y automatizar pruebas de software. |
| **Medible** | Postular a 6 oportunidades por mes, completar 60 horas de formación y publicar 2 proyectos que sumen al menos 20 pruebas automatizadas. |
| **Alcanzable** | Practicará con APIs y aplicaciones web o móviles, utilizando proyectos propios y herramientas accesibles para construir su portafolio. |
...
| Criterio SMART | Aplicación concreta |
|---|---|
| **Específico** | Aprender Git, contenedores, automatización y fundamentos de nube para crear pipelines de integración continua. |
| **Medible** | Completar 80 horas de formación, implementar pipelines en 2 proyectos y recoger al menos 3 recomendaciones profesionales. |
| **Alcanzable** | Avanzará por etapas y dedicará entre 3 y 4 horas semanales, priorizando herramientas presentes en vacantes reales. |
| **Relevante** | La automatización complementará su perfil de calidad y le permitirá participar en procesos de entrega más seguros. |
| **Temporal** | Finalizará la formación y los 2 pipelines dentro de los 24 meses posteriores a su graduación. |
...
La base implementada se encuentra en el módulo Profiles de la API ASP.NET Core. El diseño móvil de Android y Flutter se documenta como **no implementado** porque esos clientes todavía no existen en el workspace. Los tres productos comparten contratos REST y lenguaje ubicuo, mientras la API conserva las reglas autoritativas.
...
La base implementada se encuentra en el módulo Clients de la API ASP.NET Core. El diseño móvil de Android y Flutter se documenta como **no implementado** porque esos clientes todavía no existen en el workspace. Los tres productos comparten contratos REST y lenguaje ubicuo, mientras la API conserva las reglas autoritativas.
...
| Campo | Detalle |
|---|---|
| **Producto y estado** | Backend y modelos equivalentes Android/Flutter — **No implementado** |
...
La base implementada se encuentra en el módulo Subscriptions de la API ASP.NET Core. El diseño móvil de Android y Flutter se documenta como **no implementado** porque esos clientes todavía no existen en el workspace. Los tres productos comparten contratos REST y lenguaje ubicuo, mientras la API conserva las reglas autoritativas.
...
| Campo | Detalle |
|---|---|
| **Producto y estado** | Backend; modelo equivalente en Android y Flutter — **No implementado** |
