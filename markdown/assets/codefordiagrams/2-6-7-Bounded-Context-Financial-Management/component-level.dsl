workspace "AniTec - Financial Management Components" "Vistas C4 de componentes del bounded context Financial Management." {
    model {
        user = person "Authenticated Mobile User" "Ganadero o veterinario autorizado para usar las capacidades del contexto."
        external1 = softwareSystem "Profiles Context" "Dependencia externa de Financial Management."
        external2 = softwareSystem "Analytics Context" "Dependencia externa de Financial Management."
        ...
        anitec = softwareSystem "AniTec" "Solución móvil para gestión ganadera." {
            api = container "AniTec REST API" "Backend y fuente autoritativa de reglas de negocio." "C# y ASP.NET Core" {
                apiController = component "REST Interface" "Controladores: FinancialRecordsController." "ASP.NET Core Controllers"
                apiAssembler = component "Resource Assemblers" "Traduce resources y comandos sin exponer entidades." "C#"
                apiApplication = component "Application Services and Handlers" "Servicios existentes: FinancialRecordCommandService, FinancialRecordQueryService. Incluye command handlers y event handlers como diseño objetivo." "C# Application Services"
                apiDomain = component "Financial Management Domain Model" "FinancialRecord; reglas, value objects y puertos del contexto." "C# Domain Model"
                repositoryPort = component "Repository Ports" "Interfaces de repositorio definidas desde el dominio." "C# Interfaces"
                repositoryAdapter = component "Persistence Adapters" "FinancialRecordRepository." "Entity Framework Core"
            }
            android = container "Native Android Application" "Cliente Android nativo." "Kotlin y Jetpack Compose" {
                androidUi = component "Financial Management Compose UI" "Pantallas y componentes visuales del contexto." "Jetpack Compose"
                androidViewModel = component "ViewModel and UI State" "Mantiene estado de presentación y procesa intenciones." "Kotlin ViewModel"
                androidUseCases = component "Mobile Use Cases" "Casos de uso de registro de movimientos y cálculo de resúmenes." "Kotlin"
            ...
            flutter = container "Cross-Platform Mobile Application" "Cliente móvil multiplataforma." "Flutter y Dart" {
                flutterUi = component "Financial Management Widgets" "Páginas y widgets del contexto." "Flutter"
    ...
    views {
        component api "BC7-ApiComponents" "Componentes backend de Financial Management." {
            include *
            autoLayout lr
        }
        component android "BC7-AndroidComponents" "Componentes Android de Financial Management." {
            include *
            autoLayout lr
        }
        component flutter "BC7-FlutterComponents" "Componentes Flutter de Financial Management." {
            include *
            autoLayout lr
        }
        styles {
