workspace "AniTec - Subscription Management Components" "Vistas C4 de componentes del bounded context Subscription Management." {
    model {
        user = person "Authenticated Mobile User" "Ganadero o veterinario autorizado para usar las capacidades del contexto."
        external1 = softwareSystem "IAM Context" "Dependencia externa de Subscription Management."
        external2 = softwareSystem "Stripe" "Dependencia externa de Subscription Management."
        ...
        anitec = softwareSystem "AniTec" "Solución móvil para gestión ganadera." {
            api = container "AniTec REST API" "Backend y fuente autoritativa de reglas de negocio." "C# y ASP.NET Core" {
                apiController = component "REST Interface" "Controladores: SubscriptionPlansController, SubscriptionsController." "ASP.NET Core Controllers"
                apiAssembler = component "Resource Assemblers" "Traduce resources y comandos sin exponer entidades." "C#"
                apiApplication = component "Application Services and Handlers" "Servicios existentes: SubscriptionPlanCommandService, SubscriptionCommandService, PaymentCommandService, SubscriptionQueryService. Incluye command handlers y event handlers como diseño objetivo." "C# Application Services"
                apiDomain = component "Subscription Management Domain Model" "Subscription; reglas, value objects y puertos del contexto." "C# Domain Model"
                repositoryPort = component "Repository Ports" "Interfaces de repositorio definidas desde el dominio." "C# Interfaces"
                repositoryAdapter = component "Persistence Adapters" "SubscriptionPlanRepository / SubscriptionRepository / PaymentRepository." "Entity Framework Core"
            }
            android = container "Native Android Application" "Cliente Android nativo." "Kotlin y Jetpack Compose" {
                androidUi = component "Subscription Management Compose UI" "Pantallas y componentes visuales del contexto." "Jetpack Compose"
                androidViewModel = component "ViewModel and UI State" "Mantiene estado de presentación y procesa intenciones." "Kotlin ViewModel"
                androidUseCases = component "Mobile Use Cases" "Casos de uso de consulta de planes, checkout, confirmación de pago y vigencia." "Kotlin"
            ...
            flutter = container "Cross-Platform Mobile Application" "Cliente móvil multiplataforma." "Flutter y Dart" {
                flutterUi = component "Subscription Management Widgets" "Páginas y widgets del contexto." "Flutter"
    ...
    views {
        component api "BC8-ApiComponents" "Componentes backend de Subscription Management." {
            include *
            autoLayout lr
        }
        component android "BC8-AndroidComponents" "Componentes Android de Subscription Management." {
            include *
            autoLayout lr
        }
        component flutter "BC8-FlutterComponents" "Componentes Flutter de Subscription Management." {
            include *
            autoLayout lr
        }
        styles {
