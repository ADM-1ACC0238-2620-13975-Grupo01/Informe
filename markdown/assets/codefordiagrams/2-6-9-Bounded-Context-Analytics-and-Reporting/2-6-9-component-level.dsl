workspace "AniTec - Analytics and Reporting Components" "Vistas C4 de componentes del bounded context Analytics and Reporting." {
    model {
        user = person "Authenticated Mobile User" "Ganadero o veterinario autorizado para usar las capacidades del contexto."
        external1 = softwareSystem "Livestock Context" "Dependencia externa de Analytics and Reporting."
        external2 = softwareSystem "Sanitary Context" "Dependencia externa de Analytics and Reporting."
        external3 = softwareSystem "Activities Context" "Dependencia externa de Analytics and Reporting."
        external4 = softwareSystem "Financial Context" "Dependencia externa de Analytics and Reporting."
        ...
        anitec = softwareSystem "AniTec" "Solución móvil para gestión ganadera." {
            api = container "AniTec REST API" "Backend y fuente autoritativa de reglas de negocio." "C# y ASP.NET Core" {
                apiController = component "REST Interface" "Controladores: DashboardAnalyticsController, ReportMetricsController." "ASP.NET Core Controllers"
                apiAssembler = component "Resource Assemblers" "Traduce resources y comandos sin exponer entidades." "C#"
                apiApplication = component "Application Services and Handlers" "Servicios existentes: ReportMetricCommandService, ReportMetricQueryService. Incluye command handlers y event handlers como diseño objetivo." "C# Application Services"
                apiDomain = component "Analytics and Reporting Domain Model" "DashboardProjection; reglas, value objects y puertos del contexto." "C# Domain Model"
                repositoryPort = component "Repository Ports" "Interfaces de repositorio definidas desde el dominio." "C# Interfaces"
                repositoryAdapter = component "Persistence Adapters" "ReportMetricRepository." "Entity Framework Core"
            }
            android = container "Native Android Application" "Cliente Android nativo." "Kotlin y Jetpack Compose" {
                androidUi = component "Analytics and Reporting Compose UI" "Pantallas y componentes visuales del contexto." "Jetpack Compose"
                androidViewModel = component "ViewModel and UI State" "Mantiene estado de presentación y procesa intenciones." "Kotlin ViewModel"
                androidUseCases = component "Mobile Use Cases" "Casos de uso de construcción y consulta de dashboards por rol y periodo." "Kotlin"
            ...
            flutter = container "Cross-Platform Mobile Application" "Cliente móvil multiplataforma." "Flutter y Dart" {
                flutterUi = component "Analytics and Reporting Widgets" "Páginas y widgets del contexto." "Flutter"
        ...
        apiApplication -> external4 "Consulta o publica información mediante un contrato explícito"
    }

    views {
        component api "BC9-ApiComponents" "Componentes backend de Analytics and Reporting." {
            include *
            autoLayout lr
        }
        component android "BC9-AndroidComponents" "Componentes Android de Analytics and Reporting." {
            include *
            autoLayout lr
        }
        component flutter "BC9-FlutterComponents" "Componentes Flutter de Analytics and Reporting." {
            include *
            autoLayout lr
        }
        styles {
