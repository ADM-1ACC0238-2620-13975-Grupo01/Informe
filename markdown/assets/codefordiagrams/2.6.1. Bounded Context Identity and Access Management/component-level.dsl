workspace "AniTec - Identity and Access Management Components" "Vistas C4 de componentes del bounded context Identity and Access Management." {
    model {
        user = person "Authenticated Mobile User" "Ganadero o veterinario autorizado para usar las capacidades del contexto."
        external1 = softwareSystem "Profiles Context" "Dependencia externa de Identity and Access Management."
        ...
        anitec = softwareSystem "AniTec" "Solución móvil para gestión ganadera." {
            api = container "AniTec REST API" "Backend y fuente autoritativa de reglas de negocio." "C# y ASP.NET Core" {
                apiController = component "REST Interface" "Controladores: AuthenticationController, UsersController." "ASP.NET Core Controllers"
                apiAssembler = component "Resource Assemblers" "Traduce resources y comandos sin exponer entidades." "C#"
                apiApplication = component "Application Services and Handlers" "Servicios existentes: UserCommandService, UserQueryService, IamContextFacade. Incluye command handlers y event handlers como diseño objetivo." "C# Application Services"
                apiDomain = component "Identity and Access Management Domain Model" "User; reglas, value objects y puertos del contexto." "C# Domain Model"
                repositoryPort = component "Repository Ports" "Interfaces de repositorio definidas desde el dominio." "C# Interfaces"
                repositoryAdapter = component "Persistence Adapters" "UserRepository." "Entity Framework Core"
            }
            android = container "Native Android Application" "Cliente Android nativo." "Kotlin y Jetpack Compose" {
                androidUi = component "Identity and Access Management Compose UI" "Pantallas y componentes visuales del contexto." "Jetpack Compose"
                androidViewModel = component "ViewModel and UI State" "Mantiene estado de presentación y procesa intenciones." "Kotlin ViewModel"
                androidUseCases = component "Mobile Use Cases" "Casos de uso de registro, inicio de sesión, emisión y validación de JWT." "Kotlin"
            ...
            flutter = container "Cross-Platform Mobile Application" "Cliente móvil multiplataforma." "Flutter y Dart" {
                flutterUi = component "Identity and Access Management Widgets" "Páginas y widgets del contexto." "Flutter"
    ...
    views {
        component api "BC1-ApiComponents" "Componentes backend de Identity and Access Management." {
            include *
            autoLayout lr
        }
        component android "BC1-AndroidComponents" "Componentes Android de Identity and Access Management." {
            include *
            autoLayout lr
        }
        component flutter "BC1-FlutterComponents" "Componentes Flutter de Identity and Access Management." {
            include *
            autoLayout lr
        }
        styles {
