workspace "AniTec - Livestock Management Components" "Vistas C4 de componentes del bounded context Livestock Management." {
    model {
        user = person "Authenticated Mobile User" "Ganadero o veterinario autorizado para usar las capacidades del contexto."
        external1 = softwareSystem "Profiles Context" "Dependencia externa de Livestock Management."
        external2 = softwareSystem "Google ML Kit" "Dependencia externa de Livestock Management."
        ...
        anitec = softwareSystem "AniTec" "Solución móvil para gestión ganadera." {
            api = container "AniTec REST API" "Backend y fuente autoritativa de reglas de negocio." "C# y ASP.NET Core" {
                apiController = component "REST Interface" "Controladores: HerdsController, AnimalsController." "ASP.NET Core Controllers"
                apiAssembler = component "Resource Assemblers" "Traduce resources y comandos sin exponer entidades." "C#"
                apiApplication = component "Application Services and Handlers" "Servicios existentes: HerdCommandService, HerdQueryService, AnimalCommandService, AnimalQueryService. Incluye command handlers y event handlers como diseño objetivo." "C# Application Services"
                apiDomain = component "Livestock Management Domain Model" "Farm, Herd y Animal; reglas, value objects y puertos del contexto." "C# Domain Model"
                repositoryPort = component "Repository Ports" "Interfaces de repositorio definidas desde el dominio." "C# Interfaces"
                repositoryAdapter = component "Persistence Adapters" "HerdRepository / AnimalRepository." "Entity Framework Core"
            }
            android = container "Native Android Application" "Cliente Android nativo." "Kotlin y Jetpack Compose" {
                androidUi = component "Livestock Management Compose UI" "Pantallas y componentes visuales del contexto." "Jetpack Compose"
                androidViewModel = component "ViewModel and UI State" "Mantiene estado de presentación y procesa intenciones." "Kotlin ViewModel"
                androidUseCases = component "Mobile Use Cases" "Casos de uso de registro de fincas, hatos, animales y resolución de códigos QR." "Kotlin"
            ...
            flutter = container "Cross-Platform Mobile Application" "Cliente móvil multiplataforma." "Flutter y Dart" {
                flutterUi = component "Livestock Management Widgets" "Páginas y widgets del contexto." "Flutter"
    ...
    views {
        component api "BC3-ApiComponents" "Componentes backend de Livestock Management." {
            include *
            autoLayout lr
        }
        component android "BC3-AndroidComponents" "Componentes Android de Livestock Management." {
            include *
            autoLayout lr
        }
        component flutter "BC3-FlutterComponents" "Componentes Flutter de Livestock Management." {
            include *
            autoLayout lr
        }
        styles {
