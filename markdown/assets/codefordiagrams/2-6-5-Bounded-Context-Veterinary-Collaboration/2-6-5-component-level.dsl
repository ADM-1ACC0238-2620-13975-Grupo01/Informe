workspace "AniTec - Veterinary Collaboration Components" "Vistas C4 de componentes del bounded context Veterinary Collaboration." {
    model {
        user = person "Authenticated Mobile User" "Ganadero o veterinario autorizado para usar las capacidades del contexto."
        external1 = softwareSystem "IAM Context" "Dependencia externa de Veterinary Collaboration."
        external2 = softwareSystem "Profiles Context" "Dependencia externa de Veterinary Collaboration."
        external3 = softwareSystem "Livestock Context" "Dependencia externa de Veterinary Collaboration."
        ...
        anitec = softwareSystem "AniTec" "Solución móvil para gestión ganadera." {
            api = container "AniTec REST API" "Backend y fuente autoritativa de reglas de negocio." "C# y ASP.NET Core" {
                apiController = component "REST Interface" "Controladores: VeterinarianClientsController." "ASP.NET Core Controllers"
                apiAssembler = component "Resource Assemblers" "Traduce resources y comandos sin exponer entidades." "C#"
                apiApplication = component "Application Services and Handlers" "Servicios existentes: VeterinarianClientCommandService, VeterinarianClientQueryService. Incluye command handlers y event handlers como diseño objetivo." "C# Application Services"
                apiDomain = component "Veterinary Collaboration Domain Model" "VeterinarianClient; reglas, value objects y puertos del contexto." "C# Domain Model"
                repositoryPort = component "Repository Ports" "Interfaces de repositorio definidas desde el dominio." "C# Interfaces"
                repositoryAdapter = component "Persistence Adapters" "VeterinarianClientRepository." "Entity Framework Core"
            }
            android = container "Native Android Application" "Cliente Android nativo." "Kotlin y Jetpack Compose" {
                androidUi = component "Veterinary Collaboration Compose UI" "Pantallas y componentes visuales del contexto." "Jetpack Compose"
                androidViewModel = component "ViewModel and UI State" "Mantiene estado de presentación y procesa intenciones." "Kotlin ViewModel"
                androidUseCases = component "Mobile Use Cases" "Casos de uso de solicitud, aceptación, revocación y consulta de clientes y pacientes." "Kotlin"
            ...
            flutter = container "Cross-Platform Mobile Application" "Cliente móvil multiplataforma." "Flutter y Dart" {
                flutterUi = component "Veterinary Collaboration Widgets" "Páginas y widgets del contexto." "Flutter"
    ...
    views {
        component api "BC5-ApiComponents" "Componentes backend de Veterinary Collaboration." {
            include *
            autoLayout lr
        }
        component android "BC5-AndroidComponents" "Componentes Android de Veterinary Collaboration." {
            include *
            autoLayout lr
        }
        component flutter "BC5-FlutterComponents" "Componentes Flutter de Veterinary Collaboration." {
            include *
            autoLayout lr
        }
        styles {
